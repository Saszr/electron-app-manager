...
class AppPackage {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.pkg = yield ethpkg_1.ethpkg.getPackage(this.packagePath);
            if (!this.pkg) {
    ...
    get detachedMetadataPath() {
        return this.packagePath + '.metadata.json';
    }
    get packageName() {
        return path_1.default.basename(this.packagePath);
    }
    get packageNameWithoutExtension() {
        const ext = util_1.getExtension(this.packagePath);
    ...
    get extractedPackagePath() {
        return path_1.default.join(path_1.default.dirname(this.packagePath), this.packageNameWithoutExtension);
    }
    verify() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.pkg) {
            ...
            const result = yield ethpkg_1.pkgsign.verify(this.pkg);
            return result;
        });
    }
    hasEmbeddedMetadata() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const includedMeta = this.pkg ? yield this.pkg.getEntry('metadata.json') : null;
            return includedMeta !== null;
        });
    }
    hasDetachedMetadata() {
        return fs_1.default.existsSync(this.detachedMetadataPath);
    }
    getEmbeddedMetadata() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isAsar) {
                const includedMetadataPath = path_1.default.join(this.packagePath, 'metadata.json');
                // FIXME this only works for asar files in electron with patched fs
                const metadataContents = fs_1.default.readFileSync(includedMetadataPath, 'utf8');
            ...
            try {
                let entry = yield this.pkg.getEntry('metadata.json');
                if (!entry) {
                    return null;
                }
                let content = yield entry.file.readContent();
    ...
    getDetachedMetadata() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return JSON.parse(fs_1.default.readFileSync(this.detachedMetadataPath, 'utf8'));
            }
            catch (error) {
    ...
    getMetadata() {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.hasEmbeddedMetadata()) {
