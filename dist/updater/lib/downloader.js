...
exports.downloadJson = exports.download = exports.downloadStreamToBuffer = exports.request = void 0;
const http_1 = __importDefault(require("http"));
const https_1 = __importDefault(require("https"));
const url_1 = __importDefault(require("url"));
const WritableMemoryStream_1 = __importDefault(require("./WritableMemoryStream"));
function request(method, _url, opts = {}) {
    ...
    const options = Object.assign({ protocol,
        hostname,
        port,
        method,
        path }, opts);
...
function downloadStreamToBuffer(response, progress = (p) => { }) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            let completed = 0;
            let writable = new WritableMemoryStream_1.default();
...
function download(_url, onProgress = (progress) => { }, redirectCount = 0, options = { parallel: 0 }) {
    return __awaiter(this, void 0, void 0, function* () {
        if (redirectCount > 5) {
        ...
        */
        ...
        const response = yield request('GET', _url);
