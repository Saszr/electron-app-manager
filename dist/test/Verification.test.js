...
-----END PGP PUBLIC KEY BLOCK-----
  `;
    it("verifies md5 checksums", function () {
        return __awaiter(this, void 0, void 0, function* () {
            let result = checksumMd5(binFileName);
            chai_1.assert.equal(binChecksumMd5, result);
        });
    });
    it("verifies pgp signatures", function () {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield verifyPGP(binFileName, pubKeyBuildServer, detachedSig);
